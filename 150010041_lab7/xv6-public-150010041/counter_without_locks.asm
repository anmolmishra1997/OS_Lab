...
_counter_without_locks:     file format elf32-i386
...
int main()
{
  15:	83 ec 0c             	sub    $0xc,%esp
	...
	init_counters();
  18:	e8 45 03 00 00       	call   362 <init_counters>

	ret = fork();
  1d:	e8 98 02 00 00       	call   2ba <fork>
  ...
  2b:	6a 00                	push   $0x0
  2d:	e8 48 03 00 00       	call   37a <get_var>
  32:	5a                   	pop    %edx
  33:	59                   	pop    %ecx
  34:	83 c0 01             	add    $0x1,%eax
  37:	50                   	push   %eax
  38:	6a 00                	push   $0x0
  3a:	e8 43 03 00 00       	call   382 <set_var>
  ...
  58:	6a 00                	push   $0x0
  5a:	e8 1b 03 00 00       	call   37a <get_var>
		printf(1, "%d", val);
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cf:	f7 f6                	div    %esi
 3d1:	0f b6 92 5c 07 00 00 	movzbl 0x75c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 53 07 00 00       	mov    $0x753,%eax
...
free(void *ap)
{
 ...
 5d1:	a1 fc 09 00 00       	mov    0x9fc,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 64d:	a3 fc 09 00 00       	mov    %eax,0x9fc
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 fc 09 00 00    	mov    0x9fc,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6bf:	76 3f                	jbe    700 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	39 05 fc 09 00 00    	cmp    %eax,0x9fc
 ...
 6e6:	e8 e5 fe ff ff       	call   5d0 <free>
  return freep;
 6eb:	8b 15 fc 09 00 00    	mov    0x9fc,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 70c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 70f:	89 15 fc 09 00 00    	mov    %edx,0x9fc
      return (void*)(p + 1);
 ...
 724:	eb e9                	jmp    70f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 fc 09 00 00 00 	movl   $0xa00,0x9fc
 72d:	0a 00 00 
 730:	c7 05 00 0a 00 00 00 	movl   $0xa00,0xa00
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 00 0a 00 00       	mov    $0xa00,%eax
 73f:	c7 05 04 0a 00 00 00 	movl   $0x0,0xa04
 746:	00 00 00 
