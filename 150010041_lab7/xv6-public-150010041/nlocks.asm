...
int main()
{
  12:	83 ec 0c             	sub    $0xc,%esp
	...
	init_counters();
  15:	e8 b8 03 00 00       	call   3d2 <init_counters>
  1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

	for(i=0; i<10; i++)
	{
		ret = fork();
  20:	e8 05 03 00 00       	call   32a <fork>
		if (ret == 0)
  25:	85 c0                	test   %eax,%eax
  27:	0f 84 8a 00 00 00    	je     b7 <main+0xb7>
	int i;
  ...
  4b:	53                   	push   %ebx
  4c:	e8 89 03 00 00       	call   3da <acquire_lock>
				set_var(i, get_var(i)+1);
  51:	89 1c 24             	mov    %ebx,(%esp)
  54:	e8 91 03 00 00       	call   3ea <get_var>
  59:	5a                   	pop    %edx
  5a:	59                   	pop    %ecx
  5b:	83 c0 01             	add    $0x1,%eax
  5e:	50                   	push   %eax
  5f:	53                   	push   %ebx
  60:	e8 8d 03 00 00       	call   3f2 <set_var>
				release_lock(i);				
  65:	89 1c 24             	mov    %ebx,(%esp)
  68:	e8 75 03 00 00       	call   3e2 <release_lock>
	}
	else
	{
		for(int i=0; i<10; i++)
  ...
  7d:	8d 76 00             	lea    0x0(%esi),%esi
	...
	else
	{
		for(int i=0; i<10; i++)
			wait();
  80:	e8 b5 02 00 00       	call   33a <wait>
	{
		exit();
	}
	else
  ...
  93:	53                   	push   %ebx
  94:	e8 51 03 00 00       	call   3ea <get_var>
			printf(1, "data[%d] = %d\n", i, val);			
  99:	50                   	push   %eax
  9a:	53                   	push   %ebx
	}
  ...
  ad:	83 fb 0a             	cmp    $0xa,%ebx
  b0:	75 de                	jne    90 <main+0x90>
		{
			int val = get_var(i);
			printf(1, "data[%d] = %d\n", i, val);			
		}
		...
		exit();
  b2:	e8 7b 02 00 00       	call   332 <exit>
  b7:	be e8 03 00 00       	mov    $0x3e8,%esi
  ...
  c3:	53                   	push   %ebx
  c4:	e8 11 03 00 00       	call   3da <acquire_lock>
			set_var(i, get_var(i)+1);
  c9:	89 1c 24             	mov    %ebx,(%esp)
  cc:	e8 19 03 00 00       	call   3ea <get_var>
  d1:	5a                   	pop    %edx
  d2:	59                   	pop    %ecx
  d3:	83 c0 01             	add    $0x1,%eax
  d6:	50                   	push   %eax
  d7:	53                   	push   %ebx
  d8:	e8 15 03 00 00       	call   3f2 <set_var>
			release_lock(i);
  dd:	89 1c 24             	mov    %ebx,(%esp)
  e0:	e8 fd 02 00 00       	call   3e2 <release_lock>
		if (ret == 0)
			break;
	}
	if (ret == 0)
  ...
  e8:	83 ee 01             	sub    $0x1,%esi
  eb:	75 d3                	jne    c0 <main+0xc0>
  ed:	eb c3                	jmp    b2 <main+0xb2>
  ef:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43f:	f7 f6                	div    %esi
 441:	0f b6 92 d8 07 00 00 	movzbl 0x7d8(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5b8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5bb:	b8 cf 07 00 00       	mov    $0x7cf,%eax
...
free(void *ap)
{
 ...
 6ba:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6bd:	a3 78 0a 00 00       	mov    %eax,0xa78
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 72f:	76 3f                	jbe    770 <malloc+0xa0>
    ...
    if(p == freep)
 731:	39 05 78 0a 00 00    	cmp    %eax,0xa78
 ...
 756:	e8 e5 fe ff ff       	call   640 <free>
  return freep;
 75b:	8b 15 78 0a 00 00    	mov    0xa78,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 77c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 77f:	89 15 78 0a 00 00    	mov    %edx,0xa78
      return (void*)(p + 1);
 ...
 794:	eb e9                	jmp    77f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 796:	c7 05 78 0a 00 00 7c 	movl   $0xa7c,0xa78
 79d:	0a 00 00 
 7a0:	c7 05 7c 0a 00 00 7c 	movl   $0xa7c,0xa7c
 7a7:	0a 00 00 
    base.s.size = 0;
 7aa:	b8 7c 0a 00 00       	mov    $0xa7c,%eax
 7af:	c7 05 80 0a 00 00 00 	movl   $0x0,0xa80
 7b6:	00 00 00 
