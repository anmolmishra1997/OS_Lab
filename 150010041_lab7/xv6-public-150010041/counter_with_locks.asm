...
_counter_with_locks:     file format elf32-i386
...
int main()
{
  15:	83 ec 0c             	sub    $0xc,%esp
	...
	init_counters();
  18:	e8 55 03 00 00       	call   372 <init_counters>
  ...
  2b:	6a 00                	push   $0x0
  2d:	e8 48 03 00 00       	call   37a <acquire_lock>
		set_var(0, get_var(0)+1);
  32:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  39:	e8 4c 03 00 00       	call   38a <get_var>
  3e:	5a                   	pop    %edx
  3f:	59                   	pop    %ecx
  40:	83 c0 01             	add    $0x1,%eax
  43:	50                   	push   %eax
  44:	6a 00                	push   $0x0
  46:	e8 47 03 00 00       	call   392 <set_var>
		release_lock(0);
  4b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  52:	e8 2b 03 00 00       	call   382 <release_lock>
  ...
  70:	6a 00                	push   $0x0
  72:	e8 13 03 00 00       	call   38a <get_var>
		printf(1, "%d\n", val);
  77:	83 c4 0c             	add    $0xc,%esp
  7a:	50                   	push   %eax
  7b:	68 60 07 00 00       	push   $0x760
  80:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3df:	f7 f6                	div    %esi
 3e1:	0f b6 92 6c 07 00 00 	movzbl 0x76c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 558:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 55b:	b8 64 07 00 00       	mov    $0x764,%eax
